...
- (void)didReceiveNotificationRequest:(UNNotificationRequest *)request withContentHandler:(void (^)(UNNotificationContent * _Nonnull))contentHandler {
    ...
    [actionMutableArr addObjectsFromArray:[NSArray arrayWithObjects:actionA,actionB,actionC, nil]];
    if (actionMutableArr.count) {
       UNNotificationCategory * notficationCategory = [UNNotificationCategory categoryWithIdentifier:@"categoryNoOperationAction" actions:actionMutableArr intentIdentifiers:@[@"ActionA",@"ActionB",@"ActionC"] options:UNNotificationCategoryOptionCustomDismissAction];
