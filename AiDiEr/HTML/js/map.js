...
//标注点数组
var markerArr = [{title:"郑州艾迪儿网络科技有限公司",content:"地址：河南省郑州市金水区河南警察学院<br/>电话：0371-55175089<br/>email：admin@eideas.cn",point:"113.670456|34.796911",isOpen:1,icon:
...
function addMarker(){
    for(var i=0;i<markerArr.length;i++){
        ...
        (i);
        var label = new
            BMap.Label(json.title,{"offset":new BMap.Size
...
function createIcon(json){
    ...
    ("http://map.baidu.com/image/us_mk_icon.png",
        new BMap.Size(json.w,json.h),{imageOffset: new
            BMap.Size(-json.l,-json.t),infoWindowOffset:new
            BMap.Size(json.lb+5,1),offset:new BMap.Size
        (json.x,json.h)})
    return icon;
}
